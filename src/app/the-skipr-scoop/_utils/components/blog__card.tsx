...
const BlogCard = () => {
  return (
    <div className="grid grid-cols-1 [@media(min-width:860px)]:grid-cols-2 [@media(min-width:1150px)]:grid-cols-5 gap-10">
      <div className="col-span-1 [@media(min-width:1150px)]:col-span-3 relative min-h-[200px]">
        <Image
          src="/scoop1.png"
          alt="scoop1"
          fill
      ...
      <div className="col-span-1 [@media(min-width:1150px)]:col-span-2 space-y-4">
        ...
        <div className="flex flex-col [@media(min-width:400px)]:flex-row items-center justify-end [@media(min-width:400px)]:justify-between gap-4">
